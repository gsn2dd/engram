...
trap 'rm -f "$USER_DATA"' EXIT
{
    ...
    for helper in engram-fetch-keys.sh engram-welcome.sh engram-help.sh engram-aliases.sh engram-claude-code.sh; do
...
RUN_ARGS=(
    ...
    --block-device-mappings '[{"DeviceName":"/dev/xvda","Ebs":{"VolumeSize":20,"VolumeType":"gp3","Encrypted":false,"DeleteOnTermination":true}}]'
